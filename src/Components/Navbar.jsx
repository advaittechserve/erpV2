...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 z-50 w-full bg-white border-b dark:bg-gray-800 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            <button
                                ...
                                onClick={toggleSidebar} // Call toggleSidebar function on click
                            >
                            ...
                            <a href="#" className="flex ms-2 md:me-auto">
                                <img src="/src/assets/logo.jpg" className="h-12 me-3" alt="Advait Logo" />
                            ...
                            {userMenuOpen && (
                                <div className="z-50 my-4 text-base bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute right-2 top-full mt-1" id="user-dropdown">
                                    <div className="px-4 py-3">
                                        ...
                                        <span className="block text-sm text-gray-500 truncate dark:text-gray-400">{userId}</span>
                                    </div>
                                    <ul className="py-2" aria-labelledby="user-menu-button">

                                        <li>
                                            <a href="/UserSettings" className="flex w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 ">Update Profile</a>
                                        </li>

                                        <li>
                                            <button onClick={handleSignOut} className="flex w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Sign Out</button>
                                        </li>
                                    </ul>
                                </div>
                            )}
            ...
            <Sidebar isOpen={sidebarOpen} toggleSidebar={toggleSidebar} /> {/* Pass sidebarOpen state and toggleSidebar function as props */}
        </>
    );
};
