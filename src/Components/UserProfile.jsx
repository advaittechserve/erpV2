...
const UserProfile = () => {
    ...
    const confirmDeletion = async () => {
        try {
            const response = await axios.delete(`http://localhost:5000/userdetails/${userIdToDelete}`);
        ...
        { name: "session_outtime", label: "Session Out Time" },
        {
            ...
            options: {
                customBodyRender: (value, tableMeta) => (
                    <button onClick={() => handleEdituser(tableMeta.rowData)} className="add-btn">
                        Edit
                    </button>
                ),
            },
                ...
                <div className="mb-1 w-full">
                    ...
                    <div className="sm:flex">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-3 ml-auto">
                            <button type="button" onClick={toggleModal} className="submit-btn">
                                    ...
                                    <div className="p-20">
                                        <div className="">
                                            <div className="mt-3 text-center">
                                                <ErrorOutline style={{ color: 'red', fontSize: '2rem' }} />
                                                <h2 className="text-xl" id="modal-title">
                                                    Confirm Deletion
                                                </h2>
